          ...
          <div class="container-fluid">
                <div class="row col-12 page-titles">
                    <div class="col-md-5 align-self-center">
                        <b><?php echo ucwords(label('about')); ?></b>
                    </div>
                    <div class="col-md-7 align-self-right">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo REAL_PATH;?>/home"><?php echo ucwords(label('home')); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo ucwords(label('about')); ?></li>
                        </ol>
                    </div>
                </div>
                 <div class="row">
                  <div class="col-md-12 card">
                    <div class="card-body">
                      <?php if($lang=="thai"){echo $foote[0]['da_about_th'];}else{echo $foote[0]['da_about_en'];} ?>
                    </div>
                  </div>
                </div>
          </div>

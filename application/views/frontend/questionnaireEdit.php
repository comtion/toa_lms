					...
					<div class="dashElement page">
						<div class="row">
							<div class="col-md-12">
								...
								<?php echo form_open_multipart('questionnaire/editQuestionnaire'); ?>
										...
										<div class="row">
											<div class="col-sm-12">
												...
												<div class="col-sm-9 form-group has-success has-feedback">
													<input name="questionnaireName" id="questionnaireName"  class="form-control" type="text" value="<?php echo $questionnaireName;?>" required>
												</div>
												...
												<div class="col-sm-9 form-group has-success has-feedback">
													<input name="questionnaireExplanation" id="questionnaireExplanation"  class="form-control" type="text" value="<?php echo $questionnaireExplanation;?>" required>
												</div>
												...
												<div class="col-sm-9 form-group has-success has-feedback">
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="radio" name="suggestion_status" id="suggestion_status1" value="1" <?php if($suggestion_status=="1"){ echo "checked";} ?>>
													  <label class="form-check-label" for="suggestion_status1">มี</label>
													</div>
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="radio" name="suggestion_status" id="suggestion_status2" value="0" <?php if($suggestion_status=="0"){ echo "checked";} ?>>

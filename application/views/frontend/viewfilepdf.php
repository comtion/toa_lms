...
<link rel="resource" type="application/l10n" href="<?php echo base_url();?>assets/pdfjs/web/locale/locale.properties">
...
<body  tabindex="1" class="loadingInProgress">
    ...
    <script>
      ...
      document.getElementById('viewOutline').style.display = "none";
...
var defaultOptions = {
  ...
  workerSrc: {
    value: 'https://el.tripetch-isuzu.co.th/v1/assets/pdfjs/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{

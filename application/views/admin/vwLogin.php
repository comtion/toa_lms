...
<html lang="en">
  ...
  http://devzone.co.in/
  -->
    <title> มูลนิธิหัวใจแห่งประเทศไทยในพระบรมราชูปถัมภ </title>
    ...
    <link href="<?php echo HTTP_CSS_PATH_ADMIN; ?>signin.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form class="form-signin panel" method="post" action="<?php echo base_url(); ?>admin/home/do_login">
          <div class="img-logo">
            <img src="<?php echo base_url().'assets/img/skin/logo.png'; ?>" />
          </div>
        <h2 class="form-signin-heading">Control Panel</h2>

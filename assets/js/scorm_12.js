...
function SCORMapi1_2(def, cmiobj, cmiint, cmistring256, cmistring4096, scormdebugging, scormauto, scormid, cfgwwwroot, sesskey,
    ...
    var datamodelurl = cfgwwwroot + "scorm/datamodel";
    var datamodelurlparams = "&attempt=" + attempt + "&scoid=" + scoid;
    //var datamodelurlparams = "/" + cmid + "/" + scormid + "/" + sesskey + "/" + attempt + "/" + scoid;
    ...
    for(scoid in def){
        datamodel[scoid] = {
            ...
            'cmi.core.student_id':{'defaultvalue':def[scoid]['cmi_core_student_id'], 'mod':'r', 'writeerror':'403'},
            'cmi.core.student_name':{'defaultvalue':def[scoid]['cmi_core_student_name'], 'mod':'r', 'writeerror':'403'},
            'cmi.core.lesson_location':{'defaultvalue':def[scoid]['cmi_core_lesson_location'], 'format':CMIString256, 'mod':'rw', 'writeerror':'405'},
            'cmi.core.credit':{'defaultvalue':def[scoid]['cmi_core_credit'], 'mod':'r', 'writeerror':'403'},
            'cmi.core.lesson_status':{'defaultvalue':def[scoid]['cmi_core_lesson_status'], 'format':CMIStatus, 'mod':'rw', 'writeerror':'405'},
            'cmi.core.entry':{'defaultvalue':def[scoid]['cmi_core_entry'], 'mod':'r', 'writeerror':'403'},
            'cmi.core.score._children':{'defaultvalue':score_children, 'mod':'r', 'writeerror':'402'},
            'cmi.core.score.raw':{'defaultvalue':def[scoid]['cmi_core_score_raw'], 'format':CMIDecimal, 'range':score_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.core.score.max':{'defaultvalue':def[scoid]['cmi_core_score_max'], 'format':CMIDecimal, 'range':score_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.core.score.min':{'defaultvalue':def[scoid]['cmi_core_score.min'], 'format':CMIDecimal, 'range':score_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.core.total_time':{'defaultvalue':def[scoid]['cmi_core_total_time'], 'mod':'r', 'writeerror':'403'},
            'cmi.core.lesson_mode':{'defaultvalue':def[scoid]['cmi_core_lesson_mode'], 'mod':'r', 'writeerror':'403'},
            'cmi.core.exit':{'defaultvalue':def[scoid]['cmi_core_exit'], 'format':CMIExit, 'mod':'w', 'readerror':'404', 'writeerror':'405'},
            'cmi.core.session_time':{'format':CMITimespan, 'mod':'w', 'defaultvalue':'00:00:00', 'readerror':'404', 'writeerror':'405'},
            'cmi.suspend_data':{'defaultvalue':def[scoid]['cmi_suspend_data'], 'format':CMIString4096, 'mod':'rw', 'writeerror':'405'},
            'cmi.launch_data':{'defaultvalue':def[scoid]['cmi_launch_data'], 'mod':'r', 'writeerror':'403'},
            'cmi.comments':{'defaultvalue':def[scoid]['cmi_comments'], 'format':CMIString4096, 'mod':'rw', 'writeerror':'405'},
            ...
            'cmi.student_data.mastery_score':{'defaultvalue':def[scoid]['cmi_student_data_mastery_score'], 'mod':'r', 'writeerror':'403'},
            'cmi.student_data.max_time_allowed':{'defaultvalue':def[scoid]['cmi_student_data_max_time_allowed'], 'mod':'r', 'writeerror':'403'},
            'cmi.student_data.time_limit_action':{'defaultvalue':def[scoid]['cmi_student_data_time_limit_action'], 'mod':'r', 'writeerror':'403'},
            'cmi.student_preference._children':{'defaultvalue':student_preference_children, 'mod':'r', 'writeerror':'402'},
            'cmi.student_preference.audio':{'defaultvalue':def[scoid]['cmi_student_preference_audio'], 'format':CMISInteger, 'range':audio_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.student_preference.language':{'defaultvalue':def[scoid]['cmi_student_preference_language'], 'format':CMIString256, 'mod':'rw', 'writeerror':'405'},
            'cmi.student_preference.speed':{'defaultvalue':def[scoid]['cmi_student_preference_speed'], 'format':CMISInteger, 'range':speed_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.student_preference.text':{'defaultvalue':def[scoid]['cmi_student_preference_text'], 'format':CMISInteger, 'range':text_range, 'mod':'rw', 'writeerror':'405'},
    ...
    function initdatamodel(scoid){
        ...
        datamodelurlparams = "&attempt=" + attempt + "&scoid=" + scoid;
                ...
                if (element != "cmi.core.session_time") {
                    ...
                    if ((typeof eval('datamodel["' + scoid + '"]["' + element + '"]')) != "undefined") {
                        ...
                        if (eval('datamodel["' + scoid + '"]["' + element + '"].mod') != 'r') {
                            ...
                            elementstring = '&' + (element) + '=' + encodeURIComponent(data[property]);
    ...
    function StoreData(data,storetotaltime) {
        ...
        var paramsRequest = datamodelurlparams + datastring;
//        alert(paramsRequest);//remove
//        console.log(datamodel[scoid]);
        //alert('going to:' + "<?php p($CFG->wwwroot) ?>/mod/scorm/datamodel.php" + "id=<?php p($id) ?>&a=<?php p($a) ?>&sesskey=<?php echo sesskey() ?>"+datastring);
        result = DoRequest(myRequest,datamodelurl,paramsRequest);
...
M.scorm_api.init = function(def, cmiobj, cmiint, cmistring256, cmistring4096, scormdebugging, scormauto, scormid, cfgwwwroot,
